...
def main():
    ...
    subparser.add_argument('--encoder', choices=['lstm', 'bert'], default='lstm',
                           help='encoder type: lstm (default, BiLSTM with features) or bert (fine-tuned BERT as full encoder)')
    # evaluate
